        ...
        <section>
            ...
            <div class="item-list">
                <article> 
                    ...
                    <p><a href="${pageContext.request.contextPath}/administration/datasource.html?action=<%= ActionPage.VALIDER_CREATION.name()%>"
                          class="btn btn-primary"><i class='fa fa-save'></i>&nbsp;Créer</a>&nbsp;
                        <a href="${pageContext.request.contextPath}/administration/datasource.html?action=<%= ActionPage.VALIDER_SUPPRESSION.name()%>"
                ...
                <article> 
                    ...
                    <p><a href="${pageContext.request.contextPath}/administration/datasource/demodata.html?action=<%= ActionPage.VALIDER_CREATION.name()%>"
